...
<script>
	...
	function openNextWindow(){
		window.open("http://localhost:8080/nft-tracker/viewProgramLevels")
	}
...
<body style="margin-top: 50px;">
	...
	<header class="w3-display-container w3-content w3-wide"
		...
		<div class="testbox">
			<form:form method="POST" action="createProgramInSystem"
				style="width:60%;letter-spacing:0px;" modelAttribute="program"
				name="addProgramForm" id="addProgramForm">
				<div class="banner">
					<h1>Add Program</h1>
				</div>
