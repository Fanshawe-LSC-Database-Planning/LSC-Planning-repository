...
.banner {
	position: relative;
	height: 210px;
	background-image: url('./createTermsheetPage.jpeg');
	background-size: cover;
	display: flex;
	justify-content: center;
	align-items: center;
...
<script>
	...
	function validateSheetNameAndSubmitForm() {
		if (document.getElementById('termSheetName').value == '') {
			alert("Please fill the sheet name!");
		} else if (document.getElementById('termName').value == '') {
			alert("Please fill the term name!");
		} else {
			document.getElementById('createTermsheetForm').action = 'createTermSheet';
			alert("TermSheet Created Successfully");

			document.getElementById('createTermsheetForm').submit();
		}
	}
</script>
</head>
...
<body style="margin-top: 50px;">
		...
		<div class="w3-bar w3-white w3-padding w3-card"
			...
			<script>
				...
				function openNextWindow(){
					window.open("http://localhost:8080/nft-tracker/addProgram")
				}
	...
	<header class="w3-display-container w3-content w3-wide"
		...
		<div class="testbox">
			<form:form id="createTermsheetForm"
				style="width:60%;letter-spacing:0px;"
				modelAttribute="termSheetRequest" method="post">
				<div class="banner">
					<h1>Create a Term sheet</h1>
				</div>
				...
				<div class="item">
					...
					<div class="city-item">
						...
						<div style="width: 500px; margin: 10px auto;">
							...
							<label for="term" style="margin-left: 60px;">Term:</label>
