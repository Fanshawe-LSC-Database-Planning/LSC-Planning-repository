...
<script>
	function deleteTerm() {
		if (document.getElementById('termId').value == '') {
			alert('Please select a term!');
		} else {
			document.getElementById('manageTermForm').action = '${pageContext.request.contextPath}/deleteTerm';
			document.getElementById("manageTermForm").submit();
...
<body style="margin-top: 50px;">
	...
	<header class="w3-display-container w3-content w3-wide"
		...
		<div class="testbox">
			<form:form method="POST" style="width:60%;letter-spacing:0px;"
				modelAttribute="term" name="manageTermForm" id="manageTermForm">
				<div class="banner">
					<h1>Select a Term</h1>
				</div>
				...
				<div class="item">
					<div class="city-item">
						...
						<div
							...
							Select a Term :
							<form:select path="termId" required="required" id="termId">
								<option value=""></option>
								<c:forEach var="term" items="${terms}">
									<option value="${term.termId}"><c:out
				...
				<div class="btn-block">
					<button type="button" style="margin: auto" onclick="deleteTerm()">Delete Term</button>
					<br> <label id="termDeletionMessage" style="color: red;">${termDeletionMessage}</label>
				</div>
			</form:form>
