...
<script type="text/javascript">
	...
	function openWindow(){
		window.open("http://localhost:8080/nft-tracker/termsForCreatingTermSheet")
	}
</script>
...
<body style="margin-top: 50px;">
	...
	<header class="w3-display-container w3-content w3-wide"
		...
		<div class="testbox">
			<form:form id="createTermForm" modelAttribute="term"
				style="width:60%;letter-spacing:0px;" action="createTerm"
				method='POST'>
				<div class="banner">
					<h1>Create a Term</h1>
				</div>
				...
				<div class="btn-block">
					<button type="button" onclick="validateCreateTermForm()">Create
						Term</button>
					<button style="right: auto" type="button" onclick="openWindow()">Next</button>
