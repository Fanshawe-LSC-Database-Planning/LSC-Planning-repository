				...
				<div class="item">
					<div class="city-item">
						<div style="width: 500px; margin: 10px auto;">
							<b><label style="color: #921d1d; margin-left: 160px;"
								id="updateFacultyMessage">${updateFacultyMessage}</label></b>
						</div>
					</div>
				</div>
				<div class="btn-block">
					<a href="professorsToUpdate"> <br>
						<button style="margin-left: 100px; margin-right: 100px"
							type="button">Update Another Faculty</button></a>
				</div>
			</form:form>
		</div>
	</header>
