...
<body
	style="background-image: url('day-planner-828611_1920.jpg'); margin-top: 10px; margin-right: 10px; margin-left: 10px; text-align: center; border-style: solid; border-width: 1px; border-left-width: 3px; border-right-width: 3px; border-color: #e6e6e6;">
	<%
	...
	<div style="background-color: transparent">
		...
		<div>
			<div>
				<h1
					style="text-align: center; background-color:transparent; color: firebrick;">LSC
