...
<script type="text/javascript">
	function updateTermBlock() {
		document.getElementById('editTermBlockofTermsheetForm').action = '${pageContext.request.contextPath}/updateTermBlock/'
				+ document.getElementById('termName').innerText
				+ "/"
				+ document.getElementById('termSheetName').innerText
				+ "/"
				+ document.getElementById('termBlockId').innerText
				+ "/"
				+ document.getElementById('termSheetId').innerText;
		document.getElementById('editTermBlockofTermsheetForm').submit();
	}

	function goBackToEditTermSheet() {
		document.getElementById('editTermBlockofTermsheetForm').action = '${pageContext.request.contextPath}/editTermSheet/'
				+ document.getElementById('termName').innerText
				+ "/"
				+ document.getElementById('termSheetId').innerText
				+ "/"
...
<body style="margin-top: 50px;">
	...
	<header class="w3-display-container w3-content w3-wide"
		...
		<div class="testbox">
			<form:form class="form-horizontal" modelAttribute="termBlockToEdit"
				id="editTermBlockofTermsheetForm" method="post"
				style="width: 70%; letter-spacing: 0px;">
				<div class="banner">
					<h1>Change the Program details</h1>
				</div>
				<br />
				<br />
				<fieldset>
					...
					<div class="columns">
						<div class="item">
							...
							<label id="termSheetId" style="color: #921d1d; display: none"
								hidden="true">${termSheetId}</label>
						</div>
						<div class="item">
							Termsheet: <b><label id="termSheetName"
								style="color: #921d1d;">${termSheetName}</label></b>
						</div>

						<div class="item" style="width: 100%">
							Program : <span>*</span> <label style="color: #921d1d;"
								id="programName">${termBlock.programName}</label>
						</div>
						<div class="item">
							Level : <span>*</span> <label id="levelName"
								style="color: #921d1d;">${termBlock.levelName}</label>
						</div>
						...
						<div class="item" style="width: 100%">
							...
							<form:input id="totalWeeks" path="totalWeeks" type="text"
								value="${termBlock.totalWeeks}"></form:input>
						</div>
				...
				<div class="btn-block">
					<button id="editTermBlock" name="editTermBlock"
						onclick="updateTermBlock()">Update Program</button>
