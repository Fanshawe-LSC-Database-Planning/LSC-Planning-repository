...
<script type="text/javascript">
	...
	window.setTimeout(function() {
		var message = document.getElementById('updateFacultyMessage');
		if (message != null) {
...
<body style="margin-top: 50px;">
	...
	<header class="w3-display-container w3-content w3-wide"
		...
		<div class="testbox">
			<form:form id="form" action="updateFaculty"
				style="width: 60%; letter-spacing: 0px;" modelAttribute="professor"
				method="post">
				...
				<div class="item">
					<div class="city-item">
						<div style="width: 500px; margin: 10px auto;">
							<label for="Professors" style="margin-left: 60px;">Select
								Faculty to update:</label>
				...
				<div class="btn-block">
					...
					<p style="color: red;" id="updateFacultyMessage">${updateFacultyMessage}</p>
				</div>
			</form:form>
