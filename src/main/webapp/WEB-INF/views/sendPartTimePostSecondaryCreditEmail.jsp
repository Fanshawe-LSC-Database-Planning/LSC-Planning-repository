...
<script type="text/javascript">
	function sendPartTimeContract() {
		var partTimeContract = document.getElementById("partTimeContractText").innerHTML;
		...
		$
				.ajax({
					...
					url : '${pageContext.request.contextPath}/sendPartTimeContractEmail',
					processData : false,
					contentType : false,
					cache : false,
					data : attachmentForm,
	...
	<div
		...
		<div>
			<fieldset style="background-color: gainsboro; border-style: none;">
				...
				<h1 style="text-align: center; color: firebrick;">Part time
					Contract Email</h1>
			</fieldset>
		</div>
		<form
		...
		<button class="button" type="button" onclick="sendPartTimeContract()">Send</button>
		<div style="background-color: White;" id="emailDiv">
			<form enctype="multipart/form-data" id="uploadAttachmentForm"
				...
				<br> <input type="text" hidden="true" style="display: none;"
					...
					>To:</label> <input value="${professor.emailId}"
					style="margin-bottom: 10px; border: 1px; border-style: solid; border-color: #6e7376; width: 95%"
					...
					type="text" id="subject" value="Contract to Hire" name="subject"><br>
				<label for="attachment">Attachment : </label><input type="file"
					name="attachment" id="attachment" />
				<div style="border-style: ridge; margin: 10px;"
					contenteditable="true" id="partTimeContractText">
					<div
						...
						<div
							...
							<p style="width: 49%; display: inline-block">
								<input type="checkbox" checked="checked"
									onclick="this.checked=!this.checked;" id="vehicle1"
									name="vehicle1" value="Post-Secondary"> <label>Post
									Secondary</label>
							</p>
							<p style="width: 49%; display: inline-block">
							...
							<p style="width: 49%; display: inline-block">
								<input type="checkbox" checked="checked"
									onclick="this.checked=!this.checked;" id="vehicle3"
									name="vehicle3" value="Credit"> <label>Credit</label>
							</p>
							<p style="width: 49%; display: inline-block">
					...
					<p>
						Your role will be as Professor in the <b>[faculty name]</b> in the
						School of <b>[insert name]</b>. You will be teaching the following
						<b>[insert the alphanumeric course designator and title,
							number or sections, [insert number of contact teaching hours per
							week];</b> in the case of clinical instruction and field supervision,
						the number of students and teaching contact hours per week].
					</p>

					<p>This is a part-time appointment starting on [enter date] and
						ending without further notice or obligation to you from the
						College on [insert date]. The College Administrative Policy P206
						(includes an appeal process), sets out provisions related to your
						compensation and terms and conditions of employment.</p>
					...
					<p>If during the term of this appointment you wish to resign or
						...
						written notice of two weeks is required. The College may terminate
						your employment at any time for cause without notice or pay in
						lieu of notice.</p>

					<p>
						Remuneration is payable at a rate of <strong>$85.46
							(80.62 excluding vacation pay)</strong> per teaching contact hour. The
						hourly rate is paid for all teaching contact hours taught and
						...
						attendances outside of classroom hours. Academic Staff are paid
						bi-weekly by direct bank deposit.
					</p>
					...
					<p>This offer is conditional upon the College's receipt of
						evidence of your highest academic credentials from the granting
						agency and our assessment of Canadian equivalency, where
					...
					<p>If upon receipt of your academic credentials, the College
						...
						constitute grounds for immediate termination of your employment.</p>
					...
					<p>
						...
						<a
							href="https://www.fanshawec.ca/about-us/corporate-information/college-policies."
