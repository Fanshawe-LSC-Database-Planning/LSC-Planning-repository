...
<script type="text/javascript">
	function updateCourse(programId, programLevelId, courseId) {
		document.getElementById('updateCourseForm').action = '${pageContext.request.contextPath}/updateCourse/'
				+ programId
				+ "/"
				+ programLevelId
				+ "/"
	...
	function goBackToManageProgramLevel(programId, programLevelId) {
		document.getElementById('updateCourseForm').action = '${pageContext.request.contextPath}/manageProgramLevel/'
			+ programId
			+ "/"
			+ programLevelId;
		document.getElementById('updateCourseForm').submit();
	...
	<header class="w3-display-container w3-content w3-wide"
		...
		<div class="testbox">
			<form:form class="form-horizontal" modelAttribute="course"
				id="updateCourseForm" method="post"
				style="width: 70%; letter-spacing: 0px;">
				<div class="banner">
					<h1>Change the course details</h1>
				</div>
				<br />
				<br />
				<fieldset>
					<legend>Course Menu</legend>
					<div class="columns">
						<div class="item">
							Course Name:
							<form:input id="courseName" path="courseName" type="text"
								value="${course.courseName}"></form:input>
						</div>
						<div class="item">
							Course Code :
							<form:input id="courseCode" path="courseCode" type="text"
								value="${course.courseCode}"></form:input>
						</div>
						<div class="item">
							Course Credit:
							<form:input id="courseCredit" path="courseCredit" type="text"
								value="${course.courseCredit}"></form:input>
						</div>
					</div>
				</fieldset>
				<div class="btn-block">
					<button type="button"
						onclick="updateCourse(${programId},${programLevelId},${course.courseId})">Update
						Course</button>
					<button type="button"
						onclick="goBackToManageProgramLevel(${programId},${programLevelId})">Back</button>
				</div>
			</form:form>
		</div>
	</header>
