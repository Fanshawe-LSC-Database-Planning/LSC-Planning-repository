...
<script>
	function validateMandateFormParameters() {
		if (document.getElementById('programId').value == '') {
			...
			document.getElementById('manageProgramForm').action = '${pageContext.request.contextPath}/manageProgram';
			document.getElementById("manageProgramForm").submit();
		}
	}
	...
	<header class="w3-display-container w3-content w3-wide"
		...
		<div class="testbox">
			<form:form method="POST" style="width:60%;letter-spacing:0px;"
				modelAttribute="program" name="manageProgramForm"
				id="manageProgramForm">
				<div class="banner">
				...
				<div class="item">
					<div class="city-item">
						...
						<div
							...
							Select a Program :
							<form:select path="programId" required="required" id="programId">
								<option value=""></option>
